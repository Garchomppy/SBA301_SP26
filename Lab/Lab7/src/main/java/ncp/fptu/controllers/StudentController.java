...
import ncp.fptu.services.StudentService;
...
public class StudentController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        try {
            ...
            System.err.println("⚠️ Failed to load students on startup: " + e.getMessage());
            e.printStackTrace();
            showAlert(Alert.AlertType.WARNING, "Database Connection Warning",
                    "Could not load students on startup. Please check your database connection.\n" +
                    "Error: " + e.getMessage());
        }
    ...
    private void handleAddStudent() {
        try {
            ...
            refreshStudentTable();
            handleClearForm(); // Xóa form sau khi thêm
        }
    ...
    private void handleUpdateStudent() {
        try {
            ...
            // Cập nhật lại TableView
            refreshStudentTable();
            handleClearForm(); // Xóa form sau khi cập nhật
        } catch (NumberFormatException nfe) {
            showAlert(Alert.AlertType.ERROR, "Lỗi", "Điểm phải là một số hợp lệ.");
        } catch (Exception e) {
    ...
    private void handleDeleteStudent() {
        try {
            ...
            // Cập nhật lại TableView
            refreshStudentTable();
            handleClearForm(); // Xóa form sau khi xóa
        } catch (Exception e) {
