        ...
        <Container>
          <div className="py-5 animate__animated animate__fadeIn">
            <h1 className="display-2 fw-bold mb-3">
              Khám Phá Thế Giới <span className="text-primary">Hoa Lan</span>
            </h1>
            <p
              className="lead fs-4 mb-4 mx-auto shadow-text"
              style={{ maxWidth: "700px" }}
            >
              Nơi hội tụ những giống lan quý hiếm, hiện đại và đẳng cấp. Mang
              thiên nhiên vào không gian sống của bạn.
            </p>
